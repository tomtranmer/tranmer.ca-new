...
## Preview Text
Get rewarded for helping your friends find great hosting! Refer a migration, earn $100 credits →
...
2. **We send an intro** → We'll introduce them to our migration services
...
**How do I know if the referral counts?**  
We'll send a confirmation email when we receive the referral, and your friend will get an intro from our team so you can both see what we send.

**When do I get my credit?**  
Your $100 credit is awarded after your referred customer completes their first billing cycle with us.

**Is there a limit?**  
Nope! Refer as many friends as you'd like.

**Questions?**  
Just reply to this email or visit our referral page for more details.
...
## Mailchimp Notes
- **Design**: Use existing TWS brand colors (blue theme recommended)
- **Logo**: Include Bradshaw Design partnership banner
- **CTA Button**: Make prominent, use primary blue (#2563eb)
- **Mobile**: Single-column layout, responsive text
- **Analytics**: Track click-through to referral page, form submissions